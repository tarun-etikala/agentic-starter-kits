...
This enables local hooks for ruff (Python lint + format) and general file hygiene checks. The same checks run in CI as a blocking gate on pull requests — installing pre-commit locally gives you faster feedback.
