...
A browser-based chat interface for interacting with the agent. Built with Flask, it provides a simple chat window with streaming responses and thread-based conversation persistence — no curl needed.
